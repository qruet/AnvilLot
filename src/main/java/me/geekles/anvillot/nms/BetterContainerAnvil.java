...
import me.geekles.anvillot.bar.ExperienceBar;
import me.geekles.anvillot.bar.TooExpensiveBar;
...
import me.geekles.anvillot.utils.RepairCostCalculator;
import me.geekles.anvillot.utils.num.Int;
 ...
 */
public class BetterContainerAnvil extends ContainerAnvil {
    ...
    public BetterContainerAnvil(int i, PlayerInventory playerinventory, final ContainerAccess containeraccess) {
        ...
        try {
            ...
            modifiersField.setInt(repairInventory, repairInventory.getModifiers() & ~Modifier.FINAL);
